...
import { createProjectPostMessage } from './add-project-modal'
...
export default {
  data: {
    modalCustomId: 'editProjectModal',
  },

  execute: async function editProject(interaction: ModalSubmitInteraction) {
